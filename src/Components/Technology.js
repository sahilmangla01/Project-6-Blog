    ...
    return(
        ...
        <div className="topStories">
            <div className="topStories__left">
                <h1 className="content__title"> Technology</h1>
                {
                    contextData.filter(e=> e.cat==="Technology").slice(0,6).map(e=>{
                        return(
                ...
                {
                    contextData.filter(e=>  e.cat==="Technology").slice(6,10).map(e=>{
                        return(
            ...
            <div className="topStories__right">
                ...
                {
                        contextData.filter(e=>e.cat==="Technology").slice(10,11).map(e=>{
                            return(
                    ...
                    {
                        contextData.filter(e=>e.cat==="Technology").slice(11,15).map(e=>{
                            return(
                ...
                <div className="advertisement">
                      <img src="https://mir-s3-cdn-cf.behance.net/project_modules/hd/f89dce86648591.5da0e605f10d2.gif" alt="gifs"/>
                                         </div>
            </div>
